        ...
        if (this.readyState == 4 && this.status == 200) {
            ...
            if (req.responseText == "notfound") {
                ...
                try {
                    ...
                    var options = {'title':'Abteilungsdaten', 'width':550, 'height':400,backgroundColor: 'transparent', legend:{textStyle:{color: '#d5d328'}}, title:{textStyle:{color: '#d5d328'}}};
